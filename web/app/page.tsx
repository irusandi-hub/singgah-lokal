...
export default function Home() {
  ...
  // distance group — the curated/selected-Place view. It does NOT replace
  ...
  const visiblePlaces = useMemo(() => {
    ...
    // "Tempat pilihan" (curated view, PO request 2026-09-25) shows the full
    // published selection — the unbounded set, independent of the radius.
    if (curatedOnly) return searchFiltered;
          ...
          {visiblePlaces[0] && (
            <div className="absolute bottom-0 left-0 right-0 z-20 rounded-t-[28px] bg-white p-5 shadow-[0_-10px_30px_rgba(0,0,0,0.12)]">
              ...
              <div className="mb-1 text-[11px] font-bold uppercase tracking-[0.18em] text-brand-accent">
                {curatedOnly ? "Tempat pilihan" : "Tempat di sekitar"}
              </div>
